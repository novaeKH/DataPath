---
title: "Experiment tracking, reproducibility и versioning"
...
module_id: module.mlops.experiments
module_order: 1
lesson_order: 1
content_path: 10 Знания/MLOps/Experiments Reproducibility and Versioning.md
skill_ids:
...
# Experiment tracking, reproducibility и versioning
...
```datapath
{
  ...
  "scenes": [
    ...
    {"type": "interactive", "component": "experiment-reproducibility-lab"},
