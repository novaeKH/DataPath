---
title: "SQL: SELECT, WHERE, GROUP BY, JOIN и CTE"
id: lesson.data-tools.sql-foundations
schema_version: 2
type: lesson
area: data-tools
status: active
...
module_id: module.data-tools.sql
module_order: 1
lesson_order: 1
content_path: 10 Знания/Инструменты/SQL Основы.md
skill_ids:
...
# SQL: SELECT, WHERE, GROUP BY, JOIN и CTE
...
```datapath
{
  ...
  "scenes": [
    ...
    {"type": "interactive", "component": "sql-join-grain-lab"},
