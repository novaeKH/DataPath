---
title: "Eigenvectors, covariance и связь с PCA"
...
module_order: 1
lesson_order: 2
content_path: 10 Знания/Математика/03 Линейная алгебра/Eigenvalues Covariance Matrix and PCA Foundations.md
skill_ids:
- math.eigen-pca
prerequisites:
...
# Eigenvectors, covariance и связь с PCA
...
```datapath
{
  ...
  "scenes": [
    ...
    {"type": "interactive", "component": "pca-projection-lab"},
