...
STAGE_MODULES: dict[str, set[str]] = {
    "orientation": {
        "module.python-ds.objects",
        "module.python-ds.protocols",
        "module.python-ds.reliability",
        "module.data-analysis.numpy",
        "module.data-analysis.pandas",
        "module.data-tools.sql-basics",
        "module.classic-ml.problem-evaluation",
        "module.math-ds.linear-algebra",
        "module.math-ds.probability",
    },
    "understanding": {
        "module.data-analysis.eda",
        "module.data-tools.sql-analytics",
        "module.data-tools.sklearn-api",
        "module.data-tools.sklearn-validation",
        "module.math-ds.calculus",
        "module.math-ds.statistics",
        "module.classic-ml.linear-models",
        "module.classic-ml.trees-ensembles",
        "module.classic-ml.preprocessing",
        "module.classic-ml.unsupervised",
        "module.deep-learning.foundations",
        "module.deep-learning.architectures",
        "module.nlp.foundations",
        "module.nlp.neural",
        "module.llm-rag.mechanics",
        "module.llm-rag.retrieval",
    },
}
...
COURSE_ORDER = {
    "course.python-ds": 10,
    "course.math-ds": 20,
    "course.data-analysis": 30,
    "course.data-tools": 40,
