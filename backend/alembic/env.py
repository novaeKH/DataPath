"""Alembic environment — подключён к настройкам DataPath.

URL базы данных берётся из app.core.config (DATAPATH_DATABASE_URL),
чтобы миграции и приложение всегда использовали одну и ту же базу.
"""
